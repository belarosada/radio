...
@section('content')
    ...
    <form class="login100-form validate-form p-b-33 p-t-5" method="POST" action="{{ route('login') }}">
        ...
        <div class="wrap-input100 validate-input" data-validate = "Enter username">
            <input id="username" type="username" placeholder="User name" class="input100{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}" required autofocus>
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 vcenter">
            <div align="center" style="margin-top:2%;">
                  <h3>Badak LNG</h3>
                  <h5>Application Monitoring Coverage Radio <br> & <br> Tracking Radio</h5>
                  <br>
                  <div align="center">
                   <img src="{{url('assets/images/logo-.jpg')}}" width="40%"/>
                  </div>
            </div>
        </div>
    </div>
    ...
    <form id="sign_in" method="POST" action="{{ route('login') }}">
        ...
        <div class="row">
            <div class="col-xs-12">
                <button class="btn btn-block btn-submit waves-effect">Login</button>
            </div>
        </div>
    </form>
